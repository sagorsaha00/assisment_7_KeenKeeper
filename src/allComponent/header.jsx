       ...
       <div>
        ...
        {!MobileScreen && (
          <nav className="flex items-center gap-8 text-lg">
            <button className="cursor-pointer flex items-center gap-2 bg-[#064E3B] text-white px-5 py-2 rounded-md hover:bg-green-800 transition">
              <IoHomeOutline />
              <span className="font-medium">Home</span>
            </button>

            <button className="cursor-pointer flex items-center gap-2 text-gray-500 hover:text-gray-800 transition">
              <MdOutlineWatchLater />
              <span>Timeline</span>
            </button>
